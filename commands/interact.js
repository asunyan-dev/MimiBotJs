  ...
  async execute(interaction) {
    ...
    if (sub === "cuddle") {
      try {
        ...
        embed
          .setTitle(
            `${interaction.user.displayName} cuddles ${user.displayName}`
          )
          .setImage(cuddle.url);
    ...
    if (sub === "kiss") {
      try {
        ...
        embed
          .setTitle(
            `${interaction.user.displayName} kisses ${user.displayName}`
          )
          .setImage(kiss.url);
    ...
    if (sub === "pat") {
      try {
        ...
        embed
          .setTitle(`${interaction.user.displayName} pats ${user.displayName}`)
          .setImage(pat.url);
    ...
    if (sub === "smug") {
      try {
        ...
        embed
          .setTitle(
            `${interaction.user.displayName} smugs at ${user.displayName}`
          )
          .setImage(smug.url);
