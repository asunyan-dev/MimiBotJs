...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if(member.roles.highest.position <= target.roles.highest.position) {
            errorEmbed.setDescription("You can't mute someone with a higher role than you.");
            return interaction.reply({embeds: [errorEmbed], flags: MessageFlags.Ephemeral});
        };

        if(target.roles.highest.position >= interaction.guild.members.me.roles.highest.position) {
            errorEmbed.setDescription("I can't mute someone with a higher role than me.");
            return interaction.reply({embeds: [errorEmbed], flags: MessageFlags.Ephemeral});
        };
        ...
        try {
            ...
            console.error(error);
            errorEmbed.setDescription("Failed to mute member. Did you give a valid duration? Do I have the right permissions?");
            return interaction.reply({embeds: [errorEmbed], flags: MessageFlags.Ephemeral});
        }
    }
}